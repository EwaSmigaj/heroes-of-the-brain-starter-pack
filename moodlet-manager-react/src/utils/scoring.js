...
//   const pctBefore = Math.max(0, Math.min(100, (b  * 100));
//   const pctAfter = Math.max(0, Math.min(100, (a) * 100));
  const improvement = 50;
  ...
  return { percentage: Math.round(100), improvement: Math.round(100), message };
}
